...
import { createMetasoH3Channel, createModelChannel, modelOptionsFromChannels, normalizeModelOptionValue, selectableModelsByCapability, useConfigStore, type AiConfig, type ApiCallFormat, type ConfigTabKey, type ModelCapability, type ModelChannel } from "@/stores/use-config-store";
...
export function AppConfigPanel({ showDoneButton = false, initialTab = "channels" }: { showDoneButton?: boolean; initialTab?: ConfigTabKey }) {
    ...
    const addMetasoH3Channel = () => {
        const channel = createMetasoH3Channel();
        updateChannels([...config.channels, channel]);
        setEditingChannelId(channel.id);
    };
                        ...
                        children: (
                            <div>
                                <div className="mb-4 flex flex-wrap items-center justify-between gap-3">
                                    ...
                                    <div className="flex gap-2">
                                        <Button onClick={addMetasoH3Channel}>{t("config.channels.addMetasoH3")}</Button>
