...
export function buildGenerationConfig(config: AiConfig, node: CanvasNodeData | undefined, mode: CanvasNodeGenerationMode): AiConfig {
    return {
        ...
        h3GenerationMode: node?.metadata?.h3GenerationMode || config.h3GenerationMode || defaultConfig.h3GenerationMode,
        h3InputMode: node?.metadata?.h3InputMode || config.h3InputMode || defaultConfig.h3InputMode,
        h3SourceTaskId: node?.metadata?.h3SourceTaskId || config.h3SourceTaskId || defaultConfig.h3SourceTaskId,
        h3ContextIrEnabled: node?.metadata?.h3ContextIrEnabled || config.h3ContextIrEnabled || defaultConfig.h3ContextIrEnabled,
