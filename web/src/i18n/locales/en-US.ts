export default {
    ...
    videoWorkbench: {
        ...
        h3: {
            ...
            regenerateTask: "Regenerate by task",
            regenerateVideo: "Regenerate by source video",
            inputMode: "Image role",
            inputAuto: "Auto",
            inputFrames: "First / last frame",
            inputReferences: "Multi-reference",
            sourceTaskId: "Source task ID",
            sourceTaskPlaceholder: "Enter a successful task ID from this MetaSo account in the last 7 days",
            contextIr: "Enable Context IR",
            sourceVideoHint: "For source-video regeneration, the first reference video is used as the source and remaining videos stay as references.",
            sourceTaskRequired: "Enter the MetaSo H3 source task ID to regenerate",
            sourceVideoRequired: "Add at least one reference video to regenerate from a source video",
            requestTooLarge: "The MetaSo H3 request body cannot exceed 64 MB. Remove some local image, video, or audio references.",
        },
    },
    canvas: {
