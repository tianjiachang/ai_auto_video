export default {
    ...
    videoWorkbench: {
        ...
        h3: {
            ...
            generationMode: "任务类型",
            generate: "生成视频",
            regenerateTask: "按任务再生成",
            regenerateVideo: "按源视频再生成",
            inputMode: "图片素材角色",
            inputAuto: "自动识别",
            inputFrames: "首尾帧",
            inputReferences: "多参考",
            sourceTaskId: "源任务 ID",
            sourceTaskPlaceholder: "输入当前 MetaSo 账号近 7 天内成功任务 ID",
            contextIr: "启用 Context IR",
            sourceVideoHint: "按源视频再生成时，第一个参考视频作为源视频，其余视频仍作为参考素材。",
            sourceTaskRequired: "请填写要再生成的 MetaSo H3 源任务 ID",
            sourceVideoRequired: "按源视频再生成时，请至少添加一个参考视频",
            requestTooLarge: "MetaSo H3 请求体不能超过 64MB，请减少本地图片、视频或音频素材",
        },
    },
    canvas: {
